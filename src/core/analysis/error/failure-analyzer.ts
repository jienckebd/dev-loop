...
import { PrdContext, Issue, FileKnowledge, Pattern, Approach } from '../../prd/coordination/context';
import { TestExecutionResult, ExtendedTestResult, FailureDetails } from '../../testing/executor';
