...
export class TestGenerator {
  ...
  private buildTestGenerationPrompt(
    ...
    sections.push(
      ...
      `- Wizard name: \`input[name*="label"], [data-drupal-selector*="label"] input\``,
      `- API Spec name: \`input[name*="api_spec_name"], [data-drupal-selector*="api-spec-name"] input\``,
      `- Description: \`input[name*="description"], textarea[name*="description"]\``,
      `- Feature checkboxes: \`input[type="checkbox"]\` inside \`group[ref*="Features"]\` or \`.form-checkboxes\``,
      `  - Look for checkboxes labeled: "API polling", "Entity relations", "Entity storage", etc.`,
      `- Schema input: \`.ace_editor, [data-drupal-selector*="schema"] textarea\` (ACE code editor)`,
      ``,
